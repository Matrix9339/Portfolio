    ...
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 flex-wrap w-full h-full p-2">
      <div className="flex-1 flex flex-col order-2 lg:order-1 rounded-lg flex-wrap p-3 my-4 backdrop-blur-sm gap-10">
        <div className="flex-1 order-0 lg:order-1 flex items-center justify-center p-2">
          <h1 className="text-red-400 lg:text-5xl text-6xl font-bold rotate-0  items-center lg:-rotate-90 hover:rotate-7 duration-300 transform origin-center h-fit text-center">
            Projects & Research
          </h1>
        </div>
        ...
        <div className="flex flex-row flex-wrap gap-10 justify-center">
          {data.map((data) => (
            <a href={data.link} target="_blank" rel="noopener noreferrer">
              <Card
                key={data.index}
                className="max-w-sm w-full min-h-[600px] max-h-[600px] md:h-[600px] bg-gradient-to-r from-gray-800 to-gray-900 shadow-lg hover:shadow-red-500/20 transition-all duration-300 flex flex-col overflow-hidden"
